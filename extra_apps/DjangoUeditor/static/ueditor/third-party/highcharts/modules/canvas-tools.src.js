	...
	function build() {
			...
			this.render = function(ctx) {
				...
				ctx.save();
					this.setContext(ctx);
						...
						else if (this.style('filters.py').hasValue()) {
							var filter = this.style('filters.py').Definition.getDefinition();
		...
		svg.Element.filter = function(node) {
			...
			this.apply = function(ctx, element) {
				...
				var filter = element.style('filters.py').value;
				element.style('filters.py').value = '';
				...
				// reassign filter
				element.style('filters.py', true).value = filter;
			}
