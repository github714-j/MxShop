...
# 测试用例
    alipay = AliPay(
        # 沙箱里面的appid值
        appid="2016103000777916",
        #notify_url是异步的url
        app_notify_url="http://121.196.55.83:8000/alipay/return/",
        # 我们自己商户的密钥
        ...
        debug=True,  # 默认False,
        return_url="http://121.196.55.83:8000/alipay/return/"
    )
    ...
    url = alipay.direct_pay(
        ...
        subject="测试订单derek",
        # 我们商户自行生成的订单号
        out_trade_no="20180427derek",
        # 订单金额
        total_amount=10,
        #成功付款后跳转到的页面，return_url同步的url
        return_url="http://121.196.55.83/alipay/return/"
    )
